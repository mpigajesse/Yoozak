...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=7),  # Augmenté à 7 jours pour le développement
    'REFRESH_TOKEN_LIFETIME': timedelta(days=30),  # Augmenté à 30 jours pour le développement
