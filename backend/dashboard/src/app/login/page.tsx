...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen w-screen flex-col bg-white dark:bg-gray-900 lg:flex-row">
      ...
      <div className="flex w-full items-center justify-center p-4 sm:p-6 md:p-8 lg:w-1/2">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-6 w-full max-w-[360px] rounded-lg bg-primary-50 p-4 border-l-4 border-primary-500 shadow-sm text-sm dark:bg-primary-900/20 dark:border-primary-600 animate-pulse-subtle"
          >
            <div className="flex items-start">
              <FiInfo className="mr-3 h-5 w-5 mt-0.5 text-primary-600 dark:text-primary-400" />
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mb-4 w-full max-w-[360px] rounded-lg bg-red-50 p-4 border-l-4 border-red-500 shadow-sm text-sm dark:bg-red-900/20 dark:border-red-700"
            >
              <div className="flex items-start">
                <svg className="mr-3 h-5 w-5 mt-0.5 text-red-600 dark:text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-primary-500 dark:text-primary-400">
                  <FiUser size={18} />
                </span>
                <motion.input
                  id="username"
              ...
              {loginAttempted && !username.trim() && (
                <p className="mt-1 text-xs text-red-500">Le nom d'utilisateur est requis</p>
              )}
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="relative">
                ...
                {loginAttempted && !password.trim() && (
                  <p className="mt-1 text-xs text-red-500">Le mot de passe est requis</p>
                )}
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="flex items-center justify-between">
              <label className="flex cursor-pointer items-center">
                <input 
                  ...
                  className="h-5 w-5 cursor-pointer rounded border-gray-300 text-primary-600 focus:ring-primary-500 dark:border-gray-700 dark:bg-gray-800"
                />
                <span className="ml-2 text-sm text-gray-600 dark:text-gray-300">Rester connecté</span>
              </label>
              <Button
                type="button"
                variant="ghost"
          ...
          >
            Besoin d'aide? 
            <a href="#" className="ml-1 font-medium text-primary-600 hover:underline dark:text-primary-400">
      ...
      <div className="hidden bg-gray-100 dark:bg-gray-800 lg:block lg:w-1/2">
        <div className="flex h-full flex-col items-center justify-center p-4 sm:p-6 lg:p-8 text-gray-700 dark:text-gray-200">
